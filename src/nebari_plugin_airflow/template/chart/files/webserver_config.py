...
CLIENT_ID = os.environ['AIRFLOW_SSO_CLIENT_ID']
CLIENT_SECRET = os.environ['AIRFLOW_SSO_CLIENT_SECRET']
OIDC_ISSUER = os.environ['AIRFLOW_SSO_ISSUER_URL']
METADATA_URL = OIDC_ISSUER + "/.well-known/openid-configuration"
